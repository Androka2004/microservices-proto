...
type CreateShippingRequest struct {
	...
	OrderItems    []*ShippingItem        `protobuf:"bytes,2,rep,name=order_items,json=orderItems,proto3" json:"order_items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateShippingRequest) GetOrderItems() []*ShippingItem {
	if x != nil {
		return x.OrderItems
	}
	return nil
...
const file_shipping_proto_rawDesc = "" +
	...
	"\vorder_items\x18\x02 \x03(\v2\r.ShippingItemR\n" +
	"orderItems\"X\n" +
	"\x16CreateShippingResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x05R\fdeliveryDays2G\n" +
	"\bShipping\x12;\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponse\"\x00B<Z:github.com/Androka2004/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_proto_depIdxs = []int32{
	0, // 0: CreateShippingRequest.order_items:type_name -> ShippingItem
